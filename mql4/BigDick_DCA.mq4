...
extern bool autoLotsize = false;                                     // Tu Dong Tinh LotSize Theo Balance
extern int lotsizePercentBasedOnBalance = 9;                         // % Lotsize Theo Balance

extern string ________GRID_SETTINGS________ = "============== SETTINGS DCA ==============";
extern int maxOrderBUY = 4;                                          // So Lenh BUY Toi Da
extern int maxOrderSELL = 4;                                         // So Lenh SELL Toi Da
